...
sub byInstitution {
  $Institutions{$a}{LONG} cmp $Institutions{$b}{LONG};
}

sub DocumentTypeByAlpha {
   $DocumentTypes{$a}{SHORT} cmp $DocumentTypes{$b}{SHORT};
}
...
sub SecurityGroupsByName {
  lc $SecurityGroups{$a}{NAME} cmp lc $SecurityGroups{$b}{NAME};
}
