...
function IdPSelectUIParms(){
    ...
    this.preferredIdP = ["https://federation-proxy.ligo.org/idp", "https://login.ligo.org/idp/shibboleth", "https://shibbi.pki.itc.u-tokyo.ac.jp/idp/shibboleth"];        // Array of entityIds to always show
    //this.hiddenIdPs = null;          // Array of entityIds to delete
    this.hiddenIdPs = ["https://cdsidp.ligo-la.caltech.edu/idp/shibboleth"];          // Array of entityIds to delete
