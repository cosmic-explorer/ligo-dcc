...
REMOTE_HOSTS=(dcc-dev1.ligo.caltech.edu)
#REMOTE_HOSTS=(dcc-dev.ligo.org)
#REMOTE_HOSTS=(dcc-test.ligo.org)

RSYNC_PATHS=(/usr1/www/html/public/)
FILE_RSYNC_PATHS=(/usr1/www/html/DocDB/)

SCRIPT_OUT="/tmp/resync_$REMOTE_HOSTS.txt"
...
mail -n -s "$REMOTE_HOST Database Replication" araya_m@ligo.caltech.edu < $SCRIPT_OUT
